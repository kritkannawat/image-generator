...
Based from [this](https://github.com/google-gemini/gemini-image-editing-nextjs-quickstart)
...
1. **Create Images**: Generate images from text prompts using Gemini 2.5 Flash
...
- ⚡ Uses Gemini 2.5 Flash Javascript SDK
...
- [Google Gemini 2.5 Flash](https://deepmind.google/technologies/gemini/) - AI model for image generation and editing
- [shadcn/ui](https://ui.shadcn.com/) - Re-usable components built using Radix UI and Tailwind CSS

## License

This project is licensed under the Apache License 2.5 - see the [LICENSE](./LICENSE) file for details.
