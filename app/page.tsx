...
export default function Home() {
  ...
  return (
    <main className="min-h-[90dvh] flex justify-center pt-12">
      <Card className="w-full max-w-4xl border-0 bg-card shadow-none">
        <CardHeader className="p-0 flex flex-col items-center justify-center space-y-2">
          <CardTitle className="text-3xl flex items-center gap-2 bg-gradient-to-r from-indigo-500 via-blue-500 to-sky-500 bg-[length:120%_100%] bg-clip-text text-transparent">
            <Wand2 className="w-8 h-8 text-primary" />
            คุณอยากได้รูปอะไรละ?
          </CardTitle>
          <span className="font-mono text-muted-foreground">
            สร้างรูปในแบบที่คุณอยากได้กัน
          </span>
        </CardHeader>
